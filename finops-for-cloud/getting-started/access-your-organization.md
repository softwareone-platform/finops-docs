...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/password_recovery.png" alt="" width="563"><figcaption><p>Select <strong>Recover password</strong> to set up your new password.</p></figcaption></figure></div>

3. Enter the verification code from the email and select **Confirm**.

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (1) (1).png" alt="" width="484"><figcaption><p>Provide the email verification code.</p></figcaption></figure></div>
...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/Login_page.png" alt="" width="473"><figcaption><p>Use the registration page to setup your account.</p></figcaption></figure></div>
...
4. Enter the verification code to confirm your email, then verify your email and select **Confirm**. You are directed to FinOps for Cloud.&#x20;
5. Select **Accept** to join your organization and start using FinOps for Cloud.

<div data-with-frame="true"><figure><img src="../../.gitbook/assets/accept_invitation.png" alt=""><figcaption><p>Accept your pending invitation.</p></figcaption></figure></div>
