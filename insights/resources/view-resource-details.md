...
2. (Optional) [Use resource filters](./#using-resource-filters) to display specific resources, or use **search** to find the required resource.
...
5. To create a new assignment rule, select **Add Assignment Rule**. For more details, see [Configure Assignment Rules](../pools/add-assignment-rules.md).
