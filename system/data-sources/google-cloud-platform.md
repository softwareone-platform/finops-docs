...
### Enable billing export <a href="#enable-billing-export" id="enable-billing-export"></a>
...
### Create a role for FinOps for Cloud <a href="#prepare-a-role-for-optscale" id="prepare-a-role-for-optscale"></a>
...
### Create a service account <a href="#create-service-account" id="create-service-account"></a>
...
### Generate an API key for your service account <a href="#generate-api-key-for-your-service-account" id="generate-api-key-for-your-service-account"></a>
...
### Connect the data source in FinOps for Cloud <a href="#connect-data-source-in-optscale" id="connect-data-source-in-optscale"></a>
