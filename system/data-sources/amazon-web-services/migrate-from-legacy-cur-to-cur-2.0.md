...
<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/image (1) (1) (1).png" alt=""><figcaption><p>Migrate to CUR 2.0 and update the credentials.</p></figcaption></figure></div>
{% endstep %}
{% endstepper %}
