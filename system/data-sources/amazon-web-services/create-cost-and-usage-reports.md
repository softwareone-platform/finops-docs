...
8. For the **S3 path prefix**, enter _reports_ as your prefix.

The following image displays the recommended CUR settings:

<div data-with-frame="true"><figure><img src="../../../.gitbook/assets/aws_create_export.png" alt=""><figcaption><p>The recommended Cost and Usage Report settings.</p></figcaption></figure></div>
